...
function handlePlayGameCreate() {
  ...
  if (room == "") return;
  gameLinkInput.setAttribute('value',`https://wordle-multiplayer.netlify.app/public/Wordle6?room=${room}`);
...
function submitGuess() {
  ...
  if (word.length < 6) {
    showAlert("Not enough words");
    shakeTiles(checkTiles);
    return;
  }
